...
const displayRegex = /<div className="w-full h-full flex items-center justify-between px-3 sm:px-4 lg:px-5">[\s\S]*?<\/div>/;

const displayReplacement = `<div className="w-full h-full flex items-center px-2 sm:px-3 md:px-4">

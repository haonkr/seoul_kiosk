...
const displayRegex = /<div className="w-full h-full flex items-center relative px-2 sm:px-3">[\s\S]*?<\/div>/;

const displayReplacement = `<div className="w-full h-full flex items-center justify-between px-3 sm:px-4 lg:px-5">
                <span className="text-[#103aae] text-[12px] sm:text-sm md:text-base lg:text-lg font-bold tracking-tight">발급부수</span>
                <div className="flex-1 flex justify-end items-center pr-4 sm:pr-6 md:pr-8">
